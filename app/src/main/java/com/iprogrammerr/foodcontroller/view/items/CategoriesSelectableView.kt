...
class CategoriesSelectableView(context: Context, private val enabledFrom: Int, categories: List<Category>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val binding = convertView?.let { DataBindingUtil.getBinding<ItemSpinnerBinding>(convertView) }
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        val binding = convertView?.let { DataBindingUtil.getBinding<ItemSpinnerDropdownBinding>(convertView) }
            ?: DataBindingUtil.inflate(
